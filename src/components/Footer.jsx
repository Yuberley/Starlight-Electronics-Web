...
export const Footer = () => {
  return (
    <footer className="flex flex-col items-center justify-center h-screen text-gray-700 bg-white mt-16">
      <div className="text-center">
        <a href="#" className="text-xl font-black leading-none text-gray-900 select-none logo uppercase"> Starlight Electronics </a>
        <p className="mt-4 text-sm text-gray-500">© 2022 - Todos los derechos reservados</p>
      </div>

      <div className="inline-flex justify-center mt-4 space-x-5">
        <a
