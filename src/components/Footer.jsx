...
export const Footer = () => {
  return (
    <footer className="inset-x-0 bottom-0 text-gray-900 bg-white body-font mt-16">
      <div className="flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
        ...
        <span className="inline-flex flex-col items-center justify-center mt-4 sm:flex-row sm:justify-start space-x-5 sm:space-x-0">
        ...
        <div className="flex flex-col sm:flex-row mt-4 space-x-5">
          ...
          <figure className="w-36 border-l mt-4 sm:mt-0 ml-6">
            <img
              className="ml-3"
              src={incontec}
